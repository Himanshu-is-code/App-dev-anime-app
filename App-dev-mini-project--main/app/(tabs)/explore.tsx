...
export default function ScheduleScreen() {
  ...
  const styles = useMemo(() => getStyles(themeColors, insets), [colorScheme, insets]);
...
// --- STYLESHEET ---
const getStyles = (themeColors: typeof lightColors | typeof darkColors, insets: { top: number, bottom: number, left: number, right: number }) => StyleSheet.create({
  safeArea: {
    flex: 1,
    backgroundColor: themeColors.background,
    paddingTop: insets.top, // Use insets for safe area padding
  },
  header: {
    flexDirection: 'row',
